...
- **Analysis:** Text-based differences representing:
  ...
  - Environment-specific strings (URLs, hostnames)
  - Configuration values

### Cluster 3: Unknown Pattern (393 deltas)
- **Type:** Unclassified
- **Action Required:** Manual review required
- **Label:** `unclassified`
- **Confidence:** Low
- **Analysis:** Deltas that don't fit standard patterns, potentially:
  - Complex nested data structure differences
  - Binary or encoded data

### Cluster 4: Structural Pattern (0 deltas in this category)
- **Type:** Data structure differences
- **Action Required:** Review
- **Label:** `structural-change`
- **Analysis:** Schema-level differences including:
